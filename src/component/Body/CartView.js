...
import { Center, VStack, Text, Image, Button, Heading, Flex, Grid, GridItem, Spacer } from '@chakra-ui/react'
import carrito from '../../assets/carrito.png'
import compras from '../../assets/compra1.png'

const Cart = () => {

  const { cartList, totalPrice, removeProduct, clean } = useCartContext()
    ...
    <Center bgImage={carrito}>
      ...
      <Spacer p='0.5rem'/>
        ...
        {cartList.length === 0 
          ? 
          <>
            <Text  mt='1rem' fontFamily='sans-serif' fontSize='3.5rem' as='b' 
            textShadow='3px 3px 3px black' color='gray.500' bgColor='whiteAlpha.800' 
            borderRadius='10px' border='2px' borderColor='blackAlpha.300' boxShadow='3px 3px 7px black'> Carrito Vacío </Text>
